...
import (
	...
	"github.com/joseluisq/drone/handler/api/acl"
	"github.com/joseluisq/drone/handler/api/auth"
	"github.com/joseluisq/drone/handler/api/badge"
	globalbuilds "github.com/joseluisq/drone/handler/api/builds"
	"github.com/joseluisq/drone/handler/api/ccmenu"
	"github.com/joseluisq/drone/handler/api/events"
	"github.com/joseluisq/drone/handler/api/queue"
	"github.com/joseluisq/drone/handler/api/repos"
	"github.com/joseluisq/drone/handler/api/repos/builds"
	"github.com/joseluisq/drone/handler/api/repos/builds/branches"
	"github.com/joseluisq/drone/handler/api/repos/builds/deploys"
	"github.com/joseluisq/drone/handler/api/repos/builds/logs"
	"github.com/joseluisq/drone/handler/api/repos/builds/pulls"
	"github.com/joseluisq/drone/handler/api/repos/builds/stages"
	"github.com/joseluisq/drone/handler/api/repos/collabs"
	"github.com/joseluisq/drone/handler/api/repos/crons"
	"github.com/joseluisq/drone/handler/api/repos/encrypt"
	"github.com/joseluisq/drone/handler/api/repos/secrets"
	"github.com/joseluisq/drone/handler/api/repos/sign"
	globalsecrets "github.com/joseluisq/drone/handler/api/secrets"
	"github.com/joseluisq/drone/handler/api/system"
	"github.com/joseluisq/drone/handler/api/user"
	"github.com/joseluisq/drone/handler/api/user/remote"
	"github.com/joseluisq/drone/handler/api/users"
